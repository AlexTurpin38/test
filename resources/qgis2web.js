...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [615591.178410, 5587667.037111, 641795.120396, 5606264.909445], maxZoom: 25, minZoom: 1
    })
});
...
map.getView().fit([615591.178410, 5587667.037111, 641795.120396, 5606264.909445], map.getSize());
